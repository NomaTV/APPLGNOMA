...
// ✅ AJUSTADO: Não precisa mais receber o ID, pois o backend usa o da sessão.
function getBrandingLogo() {
    return apiFetch('branding/get.php', { method: 'GET' });
}

// ✅ AJUSTADO: Não precisa mais receber o ID, o backend usará o da sessão.
